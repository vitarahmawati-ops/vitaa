  ...
  <div class="border border-gray-200 rounded-2xl shadow-lg overflow-hidden">
    ...
    <div class="p-6">
      <label class="block text-sm font-medium">Pilih Merek / Tipe Mobil
        <select id="mobil" onchange="isiHargaOtomatis()" class="w-full mt-1 p-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:border-gold">
          <option data-harga="220000000">Toyota Avanza</option>
          <option data-harga="170000000">Honda Brio</option>
          <option data-harga="215000000">Daihatsu Xenia</option>
          <option data-harga="270000000">Mitsubishi Xpander</option>
          <option data-harga="230000000">Suzuki Ertiga</option>
        </select>
      </label>
...
function isiHargaOtomatis(){
  ...
  const opsiTerpilih = selectMobil.options[selectMobil.selectedIndex];
  const harga = opsiTerpilih.getAttribute('data-harga');
...
document.addEventListener('DOMContentLoaded', isiHargaOtomatis);
</script>
